# Contributing to pulumitest-python
...
We discuss features and file bugs on GitHub via [Issues](https://github.com/pulumi-labs/pulumitest-python/issues) as well as [Discussions](https://github.com/pulumi-labs/pulumitest-python/discussions).
...
For larger features, we'd appreciate it if you open a [new issue](https://github.com/pulumi-labs/pulumitest-python/issues/new) before investing a lot of time so we can discuss the feature together.
Please also be sure to browse [current issues](https://github.com/pulumi-labs/pulumitest-python/issues) to make sure your issue is unique, to lighten the triage burden on our maintainers.
...
**Prerequisites:** Python 3.10+, [Pulumi CLI](https://www.pulumi.com/docs/install/), [just](https://github.com/casey/just)
